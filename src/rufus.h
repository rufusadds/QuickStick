...
#define UNATTEND_ENABLE_ADMIN               0x02000
#define UNATTEND_BCPE_EXPLOIT               0x04000
#define UNATTEND_FULL_MASK                  0x07FFF
#define UNATTEND_DEFAULT_MASK               0x076FF		// Mask of values that are persisted
#define UNATTEND_WINDOWS_TO_GO              0x10000		// Special flag for Windows To Go

#define UNATTEND_WINPE_SETUP_MASK           (UNATTEND_SECUREBOOT_TPM_MINRAM | UNATTEND_SILENT_INSTALL | UNATTEND_BCPE_EXPLOIT)
#define UNATTEND_SPECIALIZE_DEPLOYMENT_MASK (UNATTEND_NO_ONLINE_ACCOUNT | UNATTEND_QOL_ENHANCEMENTS)
#define UNATTEND_OOBE_SHELL_SETUP_MASK      (UNATTEND_NO_DATA_COLLECTION | UNATTEND_SET_USER | UNATTEND_DUPLICATE_LOCALE | UNATTEND_SILENT_INSTALL | UNATTEND_ENABLE_ADMIN)
